...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_sucsse_delete_question(self):
        ...
        :pass
        '''
        # var for pass the id to delete the record has same the id
        id_var = 4
        # code for test DELETE methods  that send DELETE reaquset
        # to /example/<int:id>
    ...
    def test_search_in_questions(self):
        ...
        '''
        data_json = {
            'searchTerm': '''Which is the only team to play in every soccer
