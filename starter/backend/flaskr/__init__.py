...
# Set up CORS. Allow '*' for origins
    ...
    def deleteQuestion(question_id):
        ...
        Two routes if use in traminal you can use single or
         collection sentence
      '''
        try:
    ...
    category, and difficulty score
        ...
        if ((question == '') or (answer == '') or
            ...
            abort(422)
        try:
            questionInsert = Question(question=question, answer=answer,
  ...
  This endpoint take category and previous question
  parameters from POST requset and return a random
   questions within the given category
  if provided, and that is not one of the previous questions.
  if quiz_category empty or previous_questions empty
   return 400 bad request
        ...
        def getRandomQuestions():
          ...
          if exit in previous questions recall self until found
          elamunt not exit
